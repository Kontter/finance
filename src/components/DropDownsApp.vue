<script setup lang="ts">
  ...
  const categories = [
    ...
    },
    {
      ...
      icon: '/src/icons/service.svg',
      sum: 0,
    },
    {
      article: 'Отели',
      articleColor: 'rgb(98 211 78)',
      icon: '/src/icons/hotel.svg',
      sum: 0,
    },
    {
      article: 'Переводы',
      articleColor: 'rgb(151 201 217)',
      icon: '/src/icons/transfer.svg',
      sum: 0,
    },
    {
      article: 'Онлайн-маркеты',
      articleColor: 'rgb(182 120 227)',
      icon: '/src/icons/onlineStore.svg',
      sum: 0,
    },
    {
      article: 'Другое',
